...
const talents = [
  ...
  talent(21002, '重点学区房', 2, '家庭教育资源充足', { MNY: 2 }, { exclude: [21003], inheritAllowed: true, tags: tags('家庭', '资源') }),
  ...
  talent(21008, '家长期望过高', 0, '家里总拿你和别人比较', { SPR: -1, MNY: 1 }, { inheritAllowed: true, tags: tags('家庭', '压力') }),
  ...
  talent(21014, '少数民族加分', 1, '你在录取政策上有优势', { SCOREMOD: 10, VOL: 10 }, { condition: 'AGE?[18]', inheritAllowed: true, tags: tags('政策', '录取') }),
...
const talentGroups = [
  [21101, '家庭背景', [
    ['教师家庭', 2, '家里有人熟悉学校系统和考试节奏', { VOL: 15, INT: 1 }, true],
    ['书香门第', 1, '家里有稳定阅读环境', { INT: 1, SPR: 1 }, true],
    ['双职工忙碌', 0, '父母很努力，但陪伴时间有限', { MNY: 1, SPR: -1 }, true],
    ['单亲坚韧', 1, '成长环境有缺口，但你很早学会扛事', { STR: 1, SPR: 1 }, true],
    ['留守童年', 0, '你很早学会独处，也更容易缺少信息支持', { SPR: -1, VOL: -8 }, true],
    ['补课自由', 2, '家里愿意为合适的辅导投入资源', { MNY: 2, VOL: 5 }, true],
    ['城市迁徙', 1, '你在转学和适应中练出韧性', { STR: 1, VOL: 5 }, true],
    ['县城熟人社会', 1, '老师和家长之间消息传得很快', { VOL: 8, SPR: -1 }, true],
    ['家有二胎', 0, '资源被分走一些，但你更会自己安排', { MNY: -1, STR: 1 }, true],
    ['隔代抚养', 0, '祖辈照顾细致，但学习规划不太跟得上', { SPR: 1, VOL: -10 }, true],
    ['开明父母', 2, '家里能尊重你的节奏和选择', { SPR: 2, VOL: 5 }, true],
    ['高压家庭', 0, '你很早开始把排名当作安全感来源', { INT: 1, SPR: -2, RSK: 5 }, true],
    ['亲戚榜样', 1, '亲戚里有人考上好大学，给了你具体参照', { VOL: 10, SPR: 1 }, true],
    ['经济起伏', 0, '家里收入忽高忽低，计划经常被打断', { MNY: -1, RSK: 5 }, true],
    ['小镇书店', 1, '你常去镇上唯一的书店消磨时间', { INT: 1, VOL: 3 }, true],
    ['父母外派', 1, '你被迫频繁适应新学校', { STR: 1, RSK: 3, VOL: 5 }, true],
    ['教育洼地', 0, '你起步平台较弱，但竞争压力也小一些', { MNY: -2, SPR: 1 }, true],
    ['强校门票', 3, '你有机会进入顶级中学体系', { MNY: 2, INT: 1, VOL: 12 }, true],
  ]],
  [21201, '学习禀赋', [
  ...
  [21401, '社会关系', [
    ...
    ['家校沟通顺畅', 2, '老师和家长的信息能及时对齐', { VOL: 12, SPR: 1 }, true],
    ['家校误会', 0, '几次沟通偏差让你压力变大', { SPR: -1, RSK: 6 }, true],
    ['学长指路', 1, '学长学姐给过你真实建议', { VOL: 12 }, true],
    ['亲友干扰', 0, '亲戚的热心建议常常互相矛盾', { VOL: -8, SPR: -1 }, true],
    ['暗恋滤镜', 0, '你有一段很分心的朦胧喜欢', { SPR: 1, INT: -1 }, true],
    ['互助小组', 1, '你们轮流讲题，基础更稳了', { INT: 1, VOL: 5 }, true],
    ['被公开比较', 0, '长期比较让你很难轻松下来', { SPR: -2, RSK: 8 }, true],
    ['关键谈话', 2, '某次谈话让你重新校准目标', { SPR: 1, VOL: 15 }, true],
    ['家长会阴影', 0, '家长会后家里气压骤降', { SPR: -1, RSK: 5 }, true],
  ...
  [21601, '黑天鹅', [
    ...
    ['政策窗口', 2, '某项政策恰好对你有利', { VOL: 12, SCOREMOD: 8 }, true],
    ['家庭变故', 0, '一次变故打乱了稳定节奏', { SPR: -2, RSK: 12 }, true],
  ...
  [21701, '志愿信息', [
    ...
    ['家庭专业偏好', 0, '家里强烈希望你读某个专业', { VOL: 5, SPR: -1 }, true],
    ...
    ['亲戚拍板', 0, '最后关头亲戚意见突然变多', { VOL: -10, SPR: -1 }, true],
...
const events = [
  ...
  event(31022, 'senior3', '二轮开始后，你反而越来越焦虑。', { SPR: -1, RSK: 6 }, { weight: 90, flag: '心态波动', tags: tags('高三', '焦虑') }),
