...
本目录是《重回高三人生模拟》独立项目的统一文档入口。后续开发不再把标准版接入现有 Laya 主工程，而是在仓库根目录新建 `gaokao-restart/` 作为独立 Web 项目开发。
...
首发版本只做《重回高三人生模拟》标准版：玩家选择 3 个天赋，分配学力、精力、资源、心态，按 3 到 18 岁、每年 4 回合推进，最终根据分数潜力、志愿情报、风险和关键事件获得录取结局。
